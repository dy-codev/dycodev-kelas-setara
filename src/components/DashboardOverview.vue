<template>
    <div class="bg-slate-900 sm:pl-10 sm:pb-2 h-screen w-full flex flex-col box-border sm:pr-2">
        <!-- Header Logo -->
        ...
        <div
            ...
            <div class="flex flex-1 min-h-0">
                ...
                <div class="flex-1 min-w-0 flex flex-col overflow-hidden">
                    ...
                    <!-- Ornamen Header Kosong agar desain konsisten -->
                ...
                >
                  ...
                  <span class="hidden md:inline">Tambah Pegawai</span>
                        ...
                        <div class="flex items-center gap-2 md:gap-4 bg-slate-900 flex-1 rounded-bl-2xl">
                            ...
                            <div title="Analitik Pembelajaran"
                                ...
                                <div
                                    ...
                                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        ...
                                        <polyline points="4,12 10,6 16,12 22,2" />
                                    </svg>
                                </div>
                            ...
                            <div title="Keterlibatan Pengguna"
                                class="flex items-center gap-3 cursor-pointer px-2 md:px-3 py-1.5 rounded-2xl shadow-sm hover:bg-slate-800 transition-colors">
                                <div
                                    class="w-8 h-8 shrink-0 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-700">
                                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    ...
                    <!-- AREA WELCOME -->
                    <main class="flex-1 overflow-y-auto px-4 md:px-8 pb-12 flex items-center justify-center">
                        <div class="text-center max-w-xl -mt-10">
                            <div
                                class="w-20 h-20 bg-indigo-100 text-indigo-600 rounded-3xl flex items-center justify-center text-4xl mx-auto mb-6 shadow-sm border border-indigo-200">
                                👋
                            </div>

                            <h1 class="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tight">
                                Welcome to <span class="text-indigo-600">Open Setara</span>
                            </h1>

                            <p class="text-slate-600 text-lg leading-relaxed mb-10">
                                Selamat datang di Dasbor Manajemen Kelas Setara. Mulai kelola kurikulum pembelajaran,
                                pantau data siswa, dan atur tim Anda dengan mudah dari satu tempat.
                            </p>

                            <!-- Shortcut Cards -->
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left">
                                <router-link to="/dash/course-management"
                                    class="p-5 bg-white border border-slate-200 rounded-2xl hover:border-indigo-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                                    <div
                                        class="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform text-xl">
                                        📚</div>
                                    <h3 class="font-bold text-slate-900 text-lg">Kelola Kursus</h3>
                                    <p class="text-sm text-slate-500 mt-1">Tambah, edit, dan atur visibilitas materi
                                        pembelajaran.</p>
                                </router-link>
                                ...
                                <router-link to="/dash/staff-management"
                                    ...
                                    <div
                                        class="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform text-xl">
                                        👥</div>
                                    <h3 class="font-bold text-slate-900 text-lg">Kelola Staf</h3>
                                    <p class="text-sm text-slate-500 mt-1">Tambahkan akun pengajar dan kelola hak akses
                                        sistem.</p>
                                </router-link>
                            </div>
                        </div>
                            ...
                            <div class="grid transition-[grid-template-rows] duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]"
                                ...
                                <div class="overflow-hidden">
                                    <div @click="handleLogout"
                                        class="flex items-center gap-3 cursor-pointer px-3 py-1.5 pt-3 overflow-hidden group">
                                        <div
                                            class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 font-bold text-sm shrink-0 group-hover:bg-rose-500/20 group-hover:text-rose-500 transition-colors">
                                        ...
                                        <span
                                            class="text-sm font-medium text-slate-400 group-hover:text-rose-500 transition-colors mr-2 truncate">
                                            Log Keluar
                                        </span>
                                    </div>
                                </div>
