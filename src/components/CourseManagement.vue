                ...
                <div class="absolute left-0 top-0 flex">
                    <div class="flex flex-col">
                        <div class="bg-slate-900 p-4 rounded-br-xl">
                            <h2 class="text-xl font-bold text-gray-200 inline">{{ isEditing ? 'Edit Mata Pelajaran' :
                                'Tambah Mata Pelajaran' }}</h2>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select v-model="form.access_type" required
                                class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all cursor-pointer">
                        ...
                        <div v-if="form.access_type === 'private'">
                            ...
                            <input v-model="form.target_institution" type="text"
                                ...
                                class="w-full px-4 py-2.5 border border-amber-300 bg-amber-50 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all"
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea v-model="form.description" rows="2"
                                class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all"></textarea>
                        </div>
              ...
              <input v-model="form.tag" type="text" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl outline-none" placeholder="Misal: SPBN Bekasi">
                        ...
                        <div class="col-span-2">
                            ...
                            <input v-model="form.link" type="text" required
                                class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl font-mono text-sm outline-none"
